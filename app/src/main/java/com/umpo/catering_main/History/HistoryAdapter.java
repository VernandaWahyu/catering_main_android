package com.umpo.catering_main.History;
...
import com.umpo.catering_main.Database.DatabaseModel;
import com.umpo.catering_main.Utils.FuctionHelper;
...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(HistoryAdapter.ViewHolder holder, int position) {
        ...
        holder.tvDate.setText(FuctionHelper.getToday());
        holder.tvJml.setText(data.getItems() + " item");
        holder.tvPrice.setText(FuctionHelper.rupiahFormat(data.getHarga()));
    }
